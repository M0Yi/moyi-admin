    ...
    <script>
        ...
        function log(containerId, message, type = 'info') {
            ...
            entry.innerHTML = `
                ...
                <span class="badge bg-${type === 'success' ? 'success' : type === 'error' ? 'danger' : type === 'warning' ? 'warning' : 'info'}">${type.toUpperCase()}</span>
                ${message}
            `;
        ...
        async function runAllTests() {
            ...
            const summary = `测试完成: ${testState.passed} 通过, ${testState.failed} 失败`;
