...
@section('title', $current_category . ' - 我的博客')
...
<section class="hero-section">
    <div class="hero-content">
        <span class="hero-badge">分类归档</span>
        <h1 class="hero-title">{{ $current_category }}</h1>
        <p class="hero-subtitle">浏览该分类下的所有文章</p>
    </div>
</section>
...
<div class="main-content">
    ...
    <div class="latest-section">
        <div class="section-header">
            ...
            <span style="color: var(--text-gray);">共 {{ $posts->total() }} 篇文章</span>
        </div>

        @forelse($posts as $post)
        <article class="article-item">
            <a href="/blog/post/{{ $post->id }}" class="article-thumbnail" style="background: linear-gradient(135deg, hsl({{ rand(200, 280) }}, 70%, 60%) 0%, hsl({{ rand(280, 340) }}, 70%, 60%) 100%);">
            </a>
        ...
        <div class="empty-state">
            ...
            <p class="empty-desc">这个分类还没有发布任何文章内容</p>
        ...
        <div class="pagination-wrap">
            <nav class="pagination">
                ...
                <a href="{{ $posts->url(1) }}" class="page-item">«</a>
                <a href="{{ $posts->previousPageUrl() }}" class="page-item">‹</a>
                @endif
                ...
                @for($i = max(1, $posts->currentPage() - 2); $i <= min($posts->lastPage(), $posts->currentPage() + 2); $i++)
                    ...
                    @else
                    <a href="{{ $posts->url($i) }}" class="page-item">{{ $i }}</a>
                    @endif
                @endfor

                @if($posts->currentPage() < $posts->lastPage())
                <a href="{{ $posts->nextPageUrl() }}" class="page-item">›</a>
                <a href="{{ $posts->url($posts->lastPage()) }}" class="page-item">»</a>
                @endif
            </nav>
        </div>
        @endif
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-widget">
            <div class="current-category-info">
                <div class="current-category-name">{{ $current_category }}</div>
                <div class="current-category-count">共 {{ $posts->total() }} 篇文章</div>
            </div>
        </div>
        ...
        <div class="sidebar-widget">
            ...
            <div class="category-list">
                <a href="/blog" class="category-item {{ !isset($current_category) ? 'active' : '' }}">
                ...
                <a href="/blog/category/{{ urlencode($category) }}" class="category-item {{ $category == $current_category ? 'active' : '' }}">
                    <span class="category-link">
                        <span class="category-icon">📄</span>
                        {{ $category }}
                    </span>
        ...
        <div class="sidebar-widget">
            ...
            <div class="tag-cloud">
                @foreach($tags as $tag)
                <a href="/blog?tag={{ urlencode($tag) }}" class="tag-item">{{ $tag }}</a>
                @endforeach
            </div>
        </div>
        @endif
        ...
        <div class="footer-grid">
            <div class="footer-brand">
                <div class="footer-logo">
                        <img src="http://www.jianhuicishan.org/_nuxt/img/logo-new.115df95.png" alt="Logo" class="footer-logo-image" style="height: 40px; width: auto; object-fit: contain;">
                </div>
            ...
            <div>
                ...
                <div class="footer-links">
                    ...
                    <a href="/blog" class="footer-link">精选文章</a>
                    <a href="/blog" class="footer-link">热门文章</a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="footer-links">
                    ...
                    <a href="/blog/category/{{ urlencode($category) }}" class="footer-link">{{ $category }}</a>
                    @endforeach
                </div>
            </div>
