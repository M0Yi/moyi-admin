<template>
  <div class="find-good-people-page">
    <!-- 页面头部 -->
...
const loadCategoryInfo = async () => {
  try {
    ...
    if (result && result.items) {
      // 查找"发现你身边的行善者"分类 (slug: find_good_people)
      const findGoodPeopleCategory = result.items.find((cat: any) => cat.slug === 'find_good_people')

      if (findGoodPeopleCategory) {
        currentCategoryId.value = findGoodPeopleCategory.id
      }
    }
  } catch (error) {
