...
// 登录相关路由（无需认证）
Router::get('/admin/login', 'App\Controller\Admin\AuthController@login');
Router::post('/admin/login', 'App\Controller\Admin\AuthController@doLogin');
...
Router::addGroup('/admin/{adminPath:[a-zA-Z0-9\-_]+}', function () {
    ...
    Router::addGroup('', function () {
        ...
        // ========================================
        // JianhuiOrg 插件管理 - 捐赠汇总
        // ========================================
        Router::addGroup('/jianhui_org/donation-summaries', function () {
            // 页面路由
            Router::get('', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@index');
            Router::get('/create', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@create');
            Router::get('/{id:\d+}/edit', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@edit');
            // 数据操作
            Router::post('', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@store');
            Router::put('/{id:\d+}', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@update');
            Router::delete('/{id:\d+}', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@destroy');
            Router::post('/batch-destroy', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@batchDestroy');
            // 特殊操作：发布/取消发布
            Router::post('/{id:\d+}/publish', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@publish');
            Router::post('/{id:\d+}/unpublish', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@unpublish');
            Router::post('/batch-publish', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@batchPublish');
            Router::post('/batch-unpublish', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@batchUnpublish');
            // 统计数据
            Router::get('/stats', 'Addons\JianhuiOrg\Controller\Admin\DonationSummaryController@stats');
        });
    }, [
        'middleware' => [
            \App\Middleware\AdminAuthMiddleware::class,
