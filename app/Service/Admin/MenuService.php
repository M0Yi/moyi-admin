...
class MenuService extends BaseService
{
    ...
    public function getFlatList(array $params = []): array
    {
        ...
        // 构建扁平化列表（带层级）
        return $this->buildFlatList($menus, 0, 0);
    }
     ...
     * 切换字段值（通用方法）
     */
    public function toggleField(int $id, string $field): \App\Model\Admin\AdminMenu
    {
        $menu = $this->findOrFail($id);
    ...
    {
        // 菜单已解耦站点，全局共享
        return $this->transaction(function () use ($sorts) {
